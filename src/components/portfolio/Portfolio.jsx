...
const ListItem =({item})=>{
    ...
    return <div className='pItem' ref={ref}>
        <motion.div animate={isInView ?"animate" :"initial"} initial="initial" variants={imageVariant} className='pImg'>
            <img src={item.img} alt={item.title}/>
        </motion.div>
        <motion.div variants={textVariant} animate={isInView ? "animate":"initial"} initial="initial" className='pText'>
